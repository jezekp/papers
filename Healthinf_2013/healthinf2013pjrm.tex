...
The internal structure consists of several components. Figure \ref{fig:component_model} shows the main components of the system together with EEG base \cite{DBLP:conf/biostec/JezekM10} integration:
\begin{itemize}
